...
const translations = {
  ...
  ta: {
    ...
    about: {
      ...
      "Tamil Nadu's trusted textile manufacturer since 2005": "2005 ????? ????????????? ???????? ????? ???? ?????????????",
      "Manufacturing Expansion": "???????? ???????????",
      "KSP Yarns was founded in Karur, Tamil Nadu, beginning as a focused yarn trading business.": "KSP Yarns ????????????? ??????? 2005?? ???? ??????? ??????????????.",
      "Built a trusted network with regional textile buyers": "?????? ??????? ????????? ????? ??????????????????? ???????? ?????????? ????????????????",
      "Established our first manufacturing facility and started scaled production for cotton and blended yarns.": "????? ???????? ??????? ???????????? ??????? ??????? ???? ????????? ??????? ???????? ??????????????.",
      "Transitioned from trading to integrated manufacturing": "???????????????? ???????????? ???????? ???????? ??????????? ???????",
      "Achieved ISO 9001 certification, strengthening process control and product quality consistency.": "ISO 9001 ????????? ?????? ????????? ??????????? ??????? ?? ??????????? ???????????????????.",
      "ISO 9001 certified quality management system": "ISO 9001 ???????????????? ?? ???????? ???????",
      "Expanded into international markets and grew supply capabilities for export-focused customers.": "??????? ?????????? ??????????? ???????? ????????????????????? ??????? ????? ??????????????????.",
      "Established long-term global customer partnerships": "???????? ???????? ????????????? ????????????? ??????????????",
      "Scaled sustainable yarn initiatives and strengthened certification-driven production standards.": "??????? ???? ?????????? ???????????????? ????????? ????????????? ?????????? ????????? ??????????????????.",
      "Expanded eco-focused product portfolio for global buyers": "???????? ????????????????????? ????? ????? ????????? ????? ?????????????????",
      "Founded in 2005 in Karur, KSP Yarns began as a yarn trading business and steadily evolved into a full-scale manufacturer. Over the years, we expanded operations, strengthened quality systems, and built long-term relationships across domestic and international markets.": "2005?? ??????? ???????? KSP Yarns ??????? ???? ??????? ??????? ??????? ????????? ???????? ????????? ?????????. ????????? ???????????? ???????????? ?? ?????????? ?????????????????? ????????? ??????? ??????? ?????????? ???????? ????????????? ??????? ???????????????.",
      "At KSP Yarns, we are committed to preserving Tamil Nadu's natural resources through responsible manufacturing. Our Karur operations use energy-efficient systems, water conservation practices, and structured waste reduction programs. We source materials locally whenever possible to support regional livelihoods and reduce transport-related emissions.": "KSP Yarns ???????????? ????????? ???????? ??????? ????? ????????????? ?????? ??????? ????????? ?????????????????. ????? ???????? ?????????????? ??????? ????? ????? ??????????, ???? ???????? ?????????? ??????? ?????????? ????? ???????? ??????? ?????????????????????. ?????????? ????? ??????????? ??????? ?????????????? ??????????? ????????? ????????????????? ??????? ??????? ?????????????? ????????????.",
      "Explore our company milestones as we grew from a small Karur trading setup into one of Tamil Nadu's reliable textile manufacturers.": "??????? ????? ???? ???????? ??????? ????????????? ???????? ????? ?????????????????? ?????? ??????? ?????? ?????? ?????????? ??????????.",
      "Click to learn more": "?????? ???? ?????? ?????????",
      "Head office and primary manufacturing facility": "????? ???????? ??????? ??????? ???????? ???????",
      "Regional operations and sourcing support": "????????? ???????????? ??????? ????????? ?????",
      "Sales office and customer support desk": "??????? ???????? ??????? ????????????? ????? ?????",
      "Distribution and logistics coordination point": "????????? ??????? ???????????? ????????????? ?????",
      "We produce over 20 different yarn varieties including cotton, blended, and specialty yarns for various applications.": "???????, ???? ??????? ??????? ??????? ????? 20?????? ???????? ???? ?????? ??????? ???????????????? ???????? ??????????.",
      "We source 85% of our raw materials from within Tamil Nadu, supporting local farmers and reducing our carbon footprint.": "?????? ???????????????? 85% ??????????????????? ??????????????; ???? ????? ??????? ?????????? ????????????????????? ??????? ??????? ???? ?????????????????.",
      "Our production blends modern technology with traditional Tamil Nadu textile techniques passed down through generations.": "?????? ???????????? ???? ?????????????????? ??????????? ???? ????????????? ????????? ????? ?????????? ?????????????????.",      // Long paragraph translations
    ...
    contact: {
      ...
      "Contact card download functionality would be implemented here": "தொடர்பு கார்டு பதிவிறக்கம் வசதி இங்கே செயல்படுத்தப்படும்",
      ...
      "Please enter a valid 10-digit phone number": "சரியான 10 இலக்க தொலைபேசி எண்ணை உள்ளிடவும்",
      "What is this about?": "இது என்னைப் பற்றியது?",
      "Subject is required": "பொருள் தேவை",
      "Write your message here...": "உங்கள் செய்தியை இங்கே எழுதுங்கள்...",
      "Message is required": "செய்தி தேவை",
      "Thank you!": "நன்றி!",
      "Your message has been sent successfully!": "உங்கள் செய்தி வெற்றிகரமாக அனுப்பப்பட்டது!",
      "We will get back to you soon.": "விரைவில் உங்களை தொடர்பு கொள்வோம்.",
      "Sending...": "அனுப்புகிறது...",
      "Error submitting form": "படிவத்தை சமர்ப்பிப்பதில் பிழை",
      "Connect With Us": "எங்களுடன் இணைக",
      "Follow Us": "எங்களை பின்தொடருங்கள்",
      "Our Location": "எங்கள் இருப்பிடம்",
      "Get Directions": "வழிகளை பெறுங்கள்"
    },
    cart: {
      "My Cart": "என் கூடை",
    ...
    recommendations: {
      ...
      "No products found with your criteria. Try increasing the creativity level!": "உங்கள் தரவுகளுக்கு பொருத்தமான தயாரிப்புகள் எதுவும் கிடைக்கவில்லை. படைப்பாற்றல் அளவை உயர்த்திப் பார்க்கவும்!",
      "Failed to generate creative recommendations. Please try again.": "படைப்பாற்றல் பரிந்துரைகளை உருவாக்க முடியவில்லை. மீண்டும் முயற்சிக்கவும்.",
      "Please select at least one filter criterion": "குறைந்தது ஒரு வடிகட்டல் அளவுகோலைத் தேர்ந்தெடுக்கவும்",
    ...
    signup: {
      ...
      "Password must be at least 8 characters long": "கடவுச்சொல் குறைந்தது 8 எழுத்துகள் இருக்க வேண்டும்",
      "Registration failed. Please try again.": "பதிவு தோல்வியடைந்தது. மீண்டும் முயற்சிக்கவும்.",
      "Google login failed. Please try again.": "Google உள்நுழைவு தோல்வியடைந்தது. மீண்டும் முயற்சிக்கவும்.",
      "Very Weak": "மிகவும் பலவீனமான",
      "Weak": "பலவீனமான",
      "Fair": "சராசரி",
      "Good": "நல்ல",
      "Strong": "வலுவான",
      "Very Strong": "மிகவும் வலுவான",
      "John Doe": "John Doe",
